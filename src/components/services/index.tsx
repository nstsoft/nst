          ...
          <div className="card">
            ...
            <div className="item back">
              ...
              <div className="text common-text">
                ...
                we craft engaging and responsive user interfaces that elevate
                the user experience to new heights. Our frontend developers
                possess extensive expertise in building interactive web
                applications that captivate and retain users.
              </div>
            </div>
          </div>
          <div className="card">
            ...
            <div className="item back">
              ...
              <div className="text common-text">
                With Node.js, a powerful runtime environment, we architect
                robust and scalable backend systems that drive the core
                functionalities of your applications. Our backend developers
                excel in building efficient APIs, handling data management, and
                ensuring seamless integration with frontend technologies.
              </div>
            </div>
          </div>
          <div className="card">
            ...
            <div className="item back">
              ...
              <div className="text common-text">
                Utilizing Electron, a cross-platform framework, we develop
                desktop applications that offer a native-like experience across
                various operating systems. From productivity tools to media
                players, our desktop development solutions cater to diverse
                business needs while ensuring performance and reliability.
              </div>
            </div>
          </div>
          <div className="card">
            ...
            <div className="item back">
              ...
              <div className="text common-text">
                ...
                development, we engineer high-performance mobile applications
                that run seamlessly on both iOS and Android platforms. Our
                mobile development team excels in delivering feature-rich and
                intuitive mobile experiences that engage users on the go.
              </div>
            </div>
          </div>
          <div className="card">
            ...
            <div className="item back">
              ...
              <div className="text common-text">
                ...
                continuous integration and delivery to accelerate
                time-to-market.
              </div>
            </div>
          </div>
