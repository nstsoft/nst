  ...
  return (
    <div className="card-item">
      ...
      <div className="text common-text">
        A visually stunning website is only half the battle. We prioritize performance optimization, ensuring that our
        websites not only look great but also load quickly, function smoothly, and deliver an exceptional user
